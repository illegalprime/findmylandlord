defmodule FindMyLandlordWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FindMyLandlordWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FindMyLandlordWeb.Gettext, "errors", msg, opts)
    end
  end
